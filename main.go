...
func main(){
	...
	v1Router.Delete("/user/feed/follow/{feedFollowId}",apiCfg.middleware(apiCfg.handlerDeleteFeedFollow))
	v1Router.Get("/user/posts",apiCfg.middleware(apiCfg.handlerGetPostsForUser))
